...
Сайт доступен в интернете на github-pages по [ссылке](https://n817.github.io/russian-travel/)

Сайт также можно скачать и открыть на компьютере:
1. Скачать сайт в виде архива из [репозитория](https://n817.com/niarga/russian-travel) на компьютер (кнопка Code, затем Download ZIP);
